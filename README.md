...
- `resample`: number of succesfull particle updates between consecutive particle resampling events. Default value is `2*n_particles`.
...
- `δ`: tuning hyperparameter governing the size of population resamplings. Default value is `δ=0.1`.
...
serialize("[ouput path]/sabc_result_single_eps", out_single_eps) 
